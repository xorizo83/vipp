const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`node HTTP <target> <duration> <request per second> <threads> <proxyfile>`); 
 // Mendefinisikan tanggal kadaluarsa yang diinginkan
var expiredDate = new Date(2025, 4, 4); // Tanggal dihitung dari 0, bulan dimulai dari 0 (Januari=0, Februari=1)

// Mendapatkan tanggal hari ini
var today = new Date();

// Memeriksa apakah tanggal hari ini sudah melewati tanggal kadaluarsa
if (today > expiredDate) {
    throw new Error("Script telah kadaluarsa dan tidak dapat dijalankan.");
} else {
    console.log("Script dapat dijalankan.");
}
 process.exit();}
 const headers = {};
 ...
 const userLicenseCode = process.argv[8];
