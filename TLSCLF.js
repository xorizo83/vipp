const net = require("net");
 ...
 if (process.argv.length < 7){
  console.log(`  Usage: node TLSCLF.js https://target.com 60 100 10 proxy.txt`); 
	 process.exit();}
 const headers = {};
 ...
 class NetSocket {
  ...
  HTTP(options, callback) {
     const parsedAddr = options.address.split(":"); // Socket Connection xen1337
     ...
     connection.on("data", chunk => { //HTTP Version Fixed 
